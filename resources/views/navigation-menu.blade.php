            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(auth()->user()->hasRole('user'))
                        ...
                        <x-jet-nav-link href="{{ route('users.user.show', auth()->user()->id) }}"
                                        :active="request()->routeIs('users.user.show')">
                            {{ __('Personal Info') }}
                        </x-jet-nav-link>

                        <x-jet-nav-link href="{{ route('users.company.show', auth()->user()->company_id) }}"
                        ...
                        @can('users-read')
                            <x-jet-nav-link href="{{ route('users.user.index') }}"
                                            :active="request()->routeIs('users.user.index')">
                                {{ __('Company Staffs') }}
                            </x-jet-nav-link>
                        @endif
                    @endif
